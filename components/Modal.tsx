...
console.log(trailer)
  ...
  return <MuiModal open={showModal} onClose={handleClose} className="fixed !top-7 left-0 right-0 z-50 mx-auto w-full max-w-5xl overflow-hidden overflow-y-scroll rounded-md scrollbar-hide">
        <>
        <button onClick={handleClose} className="modalButton right-5 top-5 position-absolute !z-40 h-9 w-9 border-none bg-[#181818] ">
            <XIcon className="h-6 w-6"/>
        </button>
        
        <div className="relative pt-[56.25%]">
        <ReactPlayer
            url={`https://www.youtube.com/watch?v=${trailer}` || `images\This-video-is-unavailable-on-YouTube.png`}
            width="100%"
            height="100%"
